/*
		crappy signal associated with certain video cards 
...
void main()
{
	...
	for(f=1;f<4;f++)
	{
	vec3 pixel1 = texture(Source, texcoord + vec2((-0.0012f / 4) * f + (0.00062f / 4), 0)).rgb;
	...
	color.r = pixelblend.r + 0.06;
	color.g = pixelblend.g + 0.054;
	color.b = pixelblend.b + 0.054;
